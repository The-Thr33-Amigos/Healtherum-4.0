...
public class MedicalHistoryTab {
    public JComponent createMedicalHistoryTab(String id) {
        ...
        medicalHistoryTabs.addTab("Allergies", createAllergiesTab());
    ...
    private JComponent createAllergiesTab() {
        ...
        // JList allergiesList = new JList();
        // TODO: populate the list with the patient's known allergies

        // JPanel formPanel = new JPanel();
        // TODO: add form components for adding new allergies

        JPanel allergiesPanel = new JPanel();
        allergiesPanel.setLayout(new BorderLayout());
        // allergiesPanel.add(new JScrollPane(allergiesList), BorderLayout.CENTER);
        // allergiesPanel.add(formPanel, BorderLayout.SOUTH);
