...
public class createAccountPanel {
    public static JPanel createAccountPanel(String firstName, String lastName, String bdate, String email, String phone, String bio,
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (validPassword) {
                    ...
                    try {
                        ...
                        String sql = "INSERT INTO basic (id, firstName, lastName, email, phone, bdate, bio, race, mailing) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
